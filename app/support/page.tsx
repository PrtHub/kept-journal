      ...
      <main id="main-content" className="relative z-10 pt-32 pb-24 flex-1">
        <div className="max-w-270 mx-auto px-6">
          <div className="prose-container">
            ...
            <h1 className="text-display mb-8 text-[#f4f4f1]">Support</h1>
            ...
            <div className="space-y-6 text-prose text-[#9aa0a6]">
              ...
              <h2 className="text-question text-[#f4f4f1] pt-4">Restoring Purchases</h2>
              <p>
              ...
              <h2 className="text-question text-[#f4f4f1] pt-4">Managing Subscriptions</h2>
              <p>
                To change or cancel your subscription, open your iPhone&apos;s Settings &gt; [Your Apple ID] &gt; Subscriptions &gt; Kept.
              </p>

              <h2 className="text-question text-[#f4f4f1] pt-4">Encrypted Backups</h2>
              <p>
              ...
              <h2 className="text-question text-[#f4f4f1] pt-4">Contact</h2>
              <p>
