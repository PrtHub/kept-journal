      ...
      <main id="main-content" className="relative z-10 pt-32 pb-24 flex-1">
        <div className="max-w-270 mx-auto px-6">
          <div className="prose-container w-full mx-auto">
            ...
            <h1 className="text-display mb-8 text-(--ink)">Privacy Policy</h1>
            ...
            <div className="space-y-6 text-prose text-(--ink-2)">
              ...
              <h2 className="text-question text-(--ink) pt-4">Data Storage</h2>
              <p>
              ...
              <h2 className="text-question text-(--ink) pt-4">Network Transmission</h2>
              <p>
              ...
              <h2 className="text-question text-(--ink) pt-4">Analytics &amp; Tracking</h2>
              <p>
              ...
              <h2 className="text-question text-(--ink) pt-4">Backups &amp; Export</h2>
              <p>
